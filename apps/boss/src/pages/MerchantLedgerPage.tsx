...
export function MerchantLedgerPage() {
  ...
  const columns: Column<MerchantLedgerEntry>[] = [
    {
      key: 'created_at',
      header: '日期',
    ...
    { key: 'txn_type', header: '类型', width: '140px' },
    {
      key: 'amount',
      header: '金额',
      render: row => {
  ...
  return (
    <div style={{ padding: 24 }}>
      <h2 style={{ margin: '0 0 20px', color: '#0066CC' }}>商家台账</h2>
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 20, background: '#fff', padding: 16, borderRadius: 12, border: '1px solid #e0e0e0', flexWrap: 'wrap' }}>
        <div>
          <label style={{ display: 'block', fontSize: 12, color: '#888', marginBottom: 4 }}>机器</label>
          <select
            value={filterKiosk}
